...
#define SCVI_STATECHART_MAIN_REGION_READI2C 0
...
typedef enum
{
	...
	Statechart_main_region_ReadI2C,
...
/*! Raises the in event 'GetSample' that is defined in the default interface scope. */ 
extern void statechart_raise_getSample(Statechart* handle);
